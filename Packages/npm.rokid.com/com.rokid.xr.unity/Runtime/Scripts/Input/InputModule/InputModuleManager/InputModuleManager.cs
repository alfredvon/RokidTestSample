...
namespace Rokid.UXR.Interaction
{
    ...
    public class InputModuleManager : MonoSingleton<InputModuleManager>
    {
        ...
        private bool EnableGlobalEventLog { get { return enableGlobalEventLog; } set { enableGlobalEventLog = value; } }
        ...
        public void ForceActiveModule(InputModuleType moduleType)
        {
            ...
            if (this.activeModuleStatus.moduleType != moduleType)
            {
                OnModuleChange?.Invoke(this.activeModuleStatus.moduleType, moduleType);
                this.activeModuleStatus.moduleType = moduleType;
                OnModuleActive?.Invoke(moduleType);
                stateChanged = true;
        ...
        {
            if (!GetTouchPadActive() && !isInputModuleLock)
            {
