...
namespace Rokid.UXR.Interaction
{
    ...
    /// Touch Ray Caster
    /// </summary>
    public class TouchRayCaster : BaseRayCaster
    {
        [SerializeField]
        ...
        protected override void Init()
        {
            ...
            {
                inputOverride = GetComponent<TouchInput>();
                if (inputOverride == null)
                {
                    inputOverride = gameObject.AddComponent<TouchInput>();
                }
            }
        }
        ...
        {
            return (base.CanDrag(delta) || RKTouchInput.Instance.GetInsideTouchCount() == 2) && TouchPadEventInput.Instance.ShouldStartDrag();
        }
        ...
        private void CalDeltaZ()
        {
            ...
            {
                Vector3 deltaZ = ray.direction * TouchPadEventInput.Instance.ForwardSpeed() * deltaZScale;
