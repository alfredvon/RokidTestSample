...
namespace Rokid.UXR.Native
{
    public partial class NativeInterface
    {
        ...
        public partial class NativeAPI
        {
            ...
            /// Release gesture
            /// </summary>
            [Obsolete("Use ReleaseGesture Instead")]
            ...
            [DllImport(ApiConstants.UXR_GFX_PLUGIN, EntryPoint = "getGestureSkeletonPosition")]
            ...
            [DllImport(ApiConstants.UXR_GFX_PLUGIN, EntryPoint = "getGestureSkeletonRotation")]
